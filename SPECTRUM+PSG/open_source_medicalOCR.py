...
local_css("C:\AI_PROJECTS\Medexdroid\styles.css")
...
def image_model(inputs: dict) -> str | list[str] | dict:
    ...
    model = ChatGroq(api_key=GROQ_API_KEY, model="LLaVA-V1.5-7B")
...
st.title("Medical OCR Scanner")
parser = JsonOutputParser(pydantic_object=PrescriptionInformations)
#st.header('Prescription Processing')
uploaded_file = st.file_uploader("Upload a Prescription image", type=["png", "jpg", "jpeg"],key="prescription_uploader")
